...
-- users table corresponds to users in keycloak
...
-- documents table corresponds to elastic documents
...
-- user permissions table defines permissions per document per user.
